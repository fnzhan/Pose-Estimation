...
class Human36M:
    def __init__(self, data_split):
        ...
        self.img_dir = osp.join('/home/xx/data/human3.6/images')
        self.annot_path = osp.join('/home/xx/data/human3.6/annotations')
        self.human_bbox_root_dir = osp.join('..', 'data', 'Human36M', 'bbox', 'bbox_human36m_output.json')
    ...
    def load_data(self):
        ...
        if self.data_split == 'test' and not cfg.use_bbox_info:
            print("Get bounding box from " + self.human_bbox_root_dir)
            bbox_root_result = {}
        ...
        for aid in db.anns.keys():
            ...
            # embed()
            if self.data_split == 'test' and not cfg.use_bbox_info:
                bbox = bbox_root_result[str(image_id)]['bbox']
            else:
    ...
    def evaluate(self, preds, result_dir):
        ...
        for n in range(sample_num):
            ...
            # prediction save
            pred_save.append({'image_id': image_id, 'joint_cam': pred_3d_kpt.tolist(), 'bbox': bbox.tolist()})
